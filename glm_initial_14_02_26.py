...
features_4 = ['angle', 'success_n-1', 'failure_n-1', 'angle_hit_n-1', 'angle_miss_n-1']
...
models = [features_0, features_1, features_2, features_3, features_4, features_5, features_6, features_7]
results = []
for model in models:
